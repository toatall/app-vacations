    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:shrink-0">
          <div class="flex items-center h-16 justify-between px-6 py-4 bg-indigo-800 md:shrink-0 md:justify-center md:w-56">       
            <logo class="fill-white m-auto" style="height: 58px; width: 58px;" />   
          ...
          <div
            ...
            <div class="flex">
              <div>
                <Button link severity="secondary" class="me-2" @click="toggleOrganizations"
